module internal Nessos.Thespian.DisposableExtensions
...
let useNested (resource : 'T when 'T :> IDisposable and 'T : equality) : NestedDisposable<'T> = 
    new NestedDisposable<'T>(resource)
