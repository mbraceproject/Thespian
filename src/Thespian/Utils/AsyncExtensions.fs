namespace Nessos.Thespian.Tools
    ...
    module AsyncExtensions = 
        ...
        type TaskCompletionSource<'T> with
            ...
            member tcs.AsyncWaitResult(timeout : int): Async<'T option> = 
                Async.AwaitTask <| tcs.Task.TimeoutAfter timeout

            /// <summary>
            ///     Asynchronously await result
            /// </summary>
            member tcs.AsyncWaitResult() : Async<'T> = Async.AwaitTask tcs.Task
